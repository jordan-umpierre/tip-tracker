...
| [docs-and-process.md](docs-and-process.md) | keeping docs from going stale, the first code review of the repo, whether the codebase reads as real engineering, test-count philosophy |
