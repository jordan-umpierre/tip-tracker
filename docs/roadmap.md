...
1. Create and submit a production build from commit `c8a5bcf` or later.
...
- Build 6 submission is in progress for App Store Connect under ASC app
  `6800162471`.
- Build 6 does not contain commits `1d1dcf3` or `c8a5bcf`; do not use it as
  acceptance evidence for the standalone history workflow or its back button.
