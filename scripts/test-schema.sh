...
accepts "a normal shift" \
  "INSERT INTO shifts ($shift_cols) VALUES ('shift-1', 'job-1', '2026-07-29', 27000, 8000, 1200, 'busy', NULL, '$now', '$now');"
...
accepts "a second shift at the same job on the same day" \
  "INSERT INTO shifts ($shift_cols) VALUES ('shift-2', 'job-1', '2026-07-29', 14400, 3000, 1200, NULL, NULL, '$now', '$now');"

# Zero tips is a slow night, not bad data.
accepts "a shift with zero tips" \
  "INSERT INTO shifts ($shift_cols) VALUES ('shift-3', 'job-1', '2026-07-28', 18000, 0, 1200, NULL, NULL, '$now', '$now');"
...
rejects "a shift with no date" \
  "INSERT INTO shifts ($shift_cols) VALUES ('shift-bad', 'job-1', NULL, 27000, 8000, 1200, NULL, NULL, '$now', '$now');"
...
rejects "a shift lasting zero seconds" \
  "INSERT INTO shifts ($shift_cols) VALUES ('shift-bad', 'job-1', '2026-07-29', 0, 8000, 1200, NULL, NULL, '$now', '$now');"

rejects "a shift lasting negative seconds" \
  "INSERT INTO shifts ($shift_cols) VALUES ('shift-bad', 'job-1', '2026-07-29', -1, 8000, 1200, NULL, NULL, '$now', '$now');"

rejects "a shift with negative tips" \
  "INSERT INTO shifts ($shift_cols) VALUES ('shift-bad', 'job-1', '2026-07-29', 27000, -1, 1200, NULL, NULL, '$now', '$now');"

rejects "a shift with a negative hourly rate" \
  "INSERT INTO shifts ($shift_cols) VALUES ('shift-bad', 'job-1', '2026-07-29', 27000, 8000, -1, NULL, NULL, '$now', '$now');"

rejects "a shift pointing at a job that does not exist" \
  "INSERT INTO shifts ($shift_cols) VALUES ('shift-bad', 'job-nope', '2026-07-29', 27000, 8000, 1200, NULL, NULL, '$now', '$now');"
...
if sqlite3 "$db" \
  "INSERT INTO shifts ($shift_cols) VALUES ('shift-orphan', 'job-nope', '2026-07-29', 27000, 8000, 1200, NULL, NULL, '$now', '$now');" \
  >/dev/null 2>&1; then
  passed=$((passed + 1))
else
